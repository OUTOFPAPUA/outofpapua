...
our $dict = {
  ...
  'Mills (1975a)' => { 
    lang_target => 'Proto-South Sulawesi',
  ...
  'Mills (1975h)' => { 
    lang_target => 'kjc', #Coastal Konjo Bantaeng
    path => 'Mills_1975_SouthSulawesi.xlsx',
    parser => 'Spreadsheet',
    sheet => 'Mak-Bant',
    columns => [
  ...
  'Mills (1975j)' => { 
    lang_target => 'Mandar', #Mandar Campalagiang
    path => 'Mills_1975_SouthSulawesi.xlsx',
    parser => 'Spreadsheet',
    sheet => 'Mdr-Camp',
    columns => [
  ...
  'Mills (1975k)' => { 
    lang_target => 'Mandar', #Mandar Sendana
    path => 'Mills_1975_SouthSulawesi.xlsx',
    parser => 'Spreadsheet',
    sheet => 'Mdr-Cend',
    columns => [
  ...
  'Mills (1975l)' => { 
    lang_target => 'Mandar', #Mandar Binuang
    path => 'Mills_1975_SouthSulawesi.xlsx',
    parser => 'Spreadsheet',
    sheet => 'Mdr-Bin',
    columns => [
  ...
  'Mills (1975m)' => { 
    lang_target => 'Mandar', #Mandar Balanipa
    path => 'Mills_1975_SouthSulawesi.xlsx',
    parser => 'Spreadsheet',
    sheet => 'Mdr-Bal',
    columns => [
  ...
  'Mills (1975n)' => { 
    lang_target => 'Mandar', #Mandar Majene
    path => 'Mills_1975_SouthSulawesi.xlsx',
    parser => 'Spreadsheet',
    sheet => 'Mdr-Maj',
    columns => [
  ...
  'van den Heuvel (2025)' => {
    lang_target => 'wms',
    path => 'Heuvel_2025_YonggomWambon.xlsx',
    parser => 'Spreadsheet',
    columns => [
      [1, 'subentry'],
      [0, 'headword'],
      ...
      [8, 'cf_Eng'],
      [10, 'nt'],
      [[11 .. 13], 'example', ['eng', 'nld']],
      [[14 .. 16], 'example', ['eng', 'nld']],
      [[17 .. 19], 'example', ['eng', 'nld']],
      [20, 'sc'],
    ],
  },
  'van den Berg (2018a)' => {
